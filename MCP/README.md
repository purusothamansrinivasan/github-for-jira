...
This MCP (Model Content Protocol) server provides access to The Jira Cloud platform REST API API functionality through HTTP, HTTPS, and STDIO transport modes.
