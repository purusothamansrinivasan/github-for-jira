...
func UpdategadgetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DashboardGadgetUpdateRequest
...
func CreateUpdategadgetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_rest_api_3_dashboard_dashboardId_gadget_gadgetId",
		mcp.WithDescription("Update gadget on dashboard"),
		...
		mcp.WithString("position", mcp.Description("Input parameter: The position of the gadget.")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    UpdategadgetHandler(cfg),
	}
}
