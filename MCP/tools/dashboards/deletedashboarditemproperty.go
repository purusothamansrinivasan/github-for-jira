...
func DeletedashboarditempropertyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletedashboarditempropertyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_rest_api_3_dashboard_dashboardId_items_itemId_properties_propertyKey",
		mcp.WithDescription("Delete dashboard item property"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletedashboarditempropertyHandler(cfg),
	}
}
