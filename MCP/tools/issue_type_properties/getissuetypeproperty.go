...
func GetissuetypepropertyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGetissuetypepropertyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_rest_api_3_issuetype_issueTypeId_properties_propertyKey",
		mcp.WithDescription("Get issue type property"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetissuetypepropertyHandler(cfg),
	}
}
