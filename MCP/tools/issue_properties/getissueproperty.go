...
func GetissuepropertyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGetissuepropertyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_rest_api_3_issue_issueIdOrKey_properties_propertyKey",
		mcp.WithDescription("Get issue property"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetissuepropertyHandler(cfg),
	}
}
