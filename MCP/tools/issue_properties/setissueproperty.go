...
func SetissuepropertyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateSetissuepropertyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_rest_api_3_issue_issueIdOrKey_properties_propertyKey",
		mcp.WithDescription("Set issue property"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    SetissuepropertyHandler(cfg),
	}
}
