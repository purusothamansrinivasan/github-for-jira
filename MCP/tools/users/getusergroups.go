...
func GetusergroupsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/rest/api/3/user/groups%s", cfg.BaseURL, queryString)
...
func CreateGetusergroupsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_rest_api_3_user_groups",
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetusergroupsHandler(cfg),
	}
}
