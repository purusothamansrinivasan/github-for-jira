...
func CreateworkflowschemeHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/rest/api/3/workflowscheme", cfg.BaseURL)
...
func CreateCreateworkflowschemeTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_rest_api_3_workflowscheme",
		mcp.WithDescription("Create workflow scheme"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreateworkflowschemeHandler(cfg),
	}
}
