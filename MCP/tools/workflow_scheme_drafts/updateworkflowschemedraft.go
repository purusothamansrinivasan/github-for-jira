...
func UpdateworkflowschemedraftHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateUpdateworkflowschemedraftTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_rest_api_3_workflowscheme_id_draft",
		mcp.WithDescription("Update draft workflow scheme"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    UpdateworkflowschemedraftHandler(cfg),
	}
}
