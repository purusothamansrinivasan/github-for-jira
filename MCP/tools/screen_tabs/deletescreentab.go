...
func DeletescreentabHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletescreentabTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_rest_api_3_screens_screenId_tabs_tabId",
		mcp.WithDescription("Delete screen tab"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletescreentabHandler(cfg),
	}
}
