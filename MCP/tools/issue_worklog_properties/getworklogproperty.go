...
func GetworklogpropertyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGetworklogpropertyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_rest_api_3_issue_issueIdOrKey_worklog_worklogId_properties_propertyKey",
		mcp.WithDescription("Get worklog property"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetworklogpropertyHandler(cfg),
	}
}
