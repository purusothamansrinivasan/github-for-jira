...
func DeleteworklogpropertyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeleteworklogpropertyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_rest_api_3_issue_issueIdOrKey_worklog_worklogId_properties_propertyKey",
		mcp.WithDescription("Delete worklog property"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeleteworklogpropertyHandler(cfg),
	}
}
