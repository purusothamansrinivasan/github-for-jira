...
func CreateRemoveuserfromgroupTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_rest_api_3_group_user",
		mcp.WithDescription("Remove user from group"),
		...
		mcp.WithString("accountId", mcp.Required(), mcp.Description("The account ID of the user, which uniquely identifies the user across all Atlassian products. For example, *5b10ac8d82e05b22cc7d4ef5*.")),
	)
