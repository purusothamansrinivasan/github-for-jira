...
func GetusersfromgroupHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/rest/api/3/group/member%s", cfg.BaseURL, queryString)
		...
		var result models.PageBeanUserDetails
...
func CreateGetusersfromgroupTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_rest_api_3_group_member",
		mcp.WithDescription("Get users from group"),
		...
		mcp.WithBoolean("includeInactiveUsers", mcp.Description("Include inactive users.")),
